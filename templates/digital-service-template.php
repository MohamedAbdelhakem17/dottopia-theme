...
<main>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="relative p-4 sm:p-6" data-aos="fade-left">
            ...
            <div class="relative h-full w-full bg-white/5 backdrop-blur-3xl rounded-3xl border border-digital/50 overflow-hidden">
                ...
                <div class="relative z-30 p-4 sm:p-6">
                    ...
                    <h3 class="font-bold text-[#FFCE26] text-lg sm:text-xl md:text-2xl hanuman-font mb-4 leading-tight">
                        Tailored Strategies
                    </h3>
        ...
        <div class="relative p-4 sm:p-6" data-aos="zoom-in">
            ...
            <div class="relative h-full w-full bg-white/5 backdrop-blur-3xl rounded-3xl border border-digital/50 overflow-hidden">
                ...
                <div class="relative z-30 p-4 sm:p-6">
                    ...
                    <p class="text-white text-xs sm:text-sm leading-relaxed">
                        Understanding your goals, audience, and industry to create customized digital marketing solutions. 
                        Maintaining consistency in delivering & posting highest quality content.
                    </p>
                </div>
            </div>
        </div>
