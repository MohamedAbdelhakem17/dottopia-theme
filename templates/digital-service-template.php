                        ...
                        <div class="w-full h-full relative z-30">
                            ...
                            <div class="p-2">
                                ...
                                <p class="font-light text-[12px] text-white leading-[17px]">
                                    Understanding your goals, audience, and industry to create customized digital marketing solutions.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <?php if ($clients) : ?>
                    <?php foreach ($clients as $client) : ?>
                        ...
                        <div class="p-4 flex justify-center items-center">
                            <?php if ($image_url) : ?>
                                <img src="<?php echo $image_url; ?>" alt="<?php echo $image_alt; ?>" class="object-contain mx-auto" />
                            <?php endif; ?>
                        </div>
                    <?php endforeach; ?>
                <?php endif; ?>
