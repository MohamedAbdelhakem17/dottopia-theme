    ...
    <header class="py-10 mb-12">
        <div class="container mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-2 px-4">
                <div class="col-span-1 flex justify-center flex-col text-center md:text-start items-center md:items-start"
                    data-aos="fade-down-right">
                    <h1 class="text-seo text-sm font-[400] "><?= $hero_section_title ?></h1>
                    <p
                        class="text-[30px] md:text-[48px] font-normal leading-[40px] md:leading-[60px] mt-2 mb-4 py-2 md:w-[90%] uppercase">
                        We increase your <br class="hidden md:block"> <span class="text-seo font-bold">website
                            traffic</span>, so you won’t have to worry about
                        <span class='inline-block p-0 m-0 text-seo font-bold'> ranking. <img
                                src='<?= get_template_directory_uri() . '/assets/images/backgrounds/seo_line.svg' ?>'
                                class='-translate-y-2'></span>
                    </p>
                ...
                <div class="col-span-1">
                    <img data-aos="fade-down-left"
                        src="<?= get_template_directory_uri() . '/assets/images/backgrounds/seo_solution.png' ?>"
                        alt="Search Engine Optimization" class=" mx-auto rounded-lg">
                </div>
            </div>
        </div>
    </header>
        ...
        <div
            ...
            <div class="w-full">
                <img src="<?php echo esc_url(get_field("strategy_image") ?: get_template_directory_uri() . '/assets/images/backgrounds/video_Cover.png'); ?>"
                    alt="Video Cover" class="w-fit mx-auto" />
            ...
            <div class="w-full px-3">
                ...
                <p
                    class="py-3 md:py-6 font-normal text-[18px] md:text-[16px] lg:w-[70%] md:w-[90%] description text-lg roboto-font">
    ...
    <section class="py-10 px-4">
        <div class="md:w-[90%] px-5 md:px-0 mx-auto text-center" style="margin: 0 auto;">
            ...
            <p
                ...
                Our approach to increase website traffic is methodical and results-oriented.Discover our detailed
                strategic process to maximize your website visits.
            </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 md:gap-y-4 items-center parallax mt-3">
                ...
                <div class="px-4 md:px-8 col-span-1 md:col-span-1">
                    <img src="<?= esc_url($image ?: $image_default) ?>" alt="<?= esc_attr(strip_tags($title)) ?>"
