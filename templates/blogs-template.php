...
<main>
        ...
        <div class="container mx-auto py-5 min-h-[70vh] flex items-center">
            <div class="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div class="col-span-1 p-5">
                    <img data-aos="fade-down-left" src="<?= get_template_directory_uri() . '/assets/images/backgrounds/seo_solution.png' ?>" alt="Search Engine Optimization" class=" mx-auto rounded-lg object-contain w-[80%] ">
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="text-center p-5 mt-10">
        ...
        <div class="flex gap-8 justify-center py-4 mt-10" data-aos="fade-in" data-aos-duration="800">
            <button
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-10">
                ...
                <?php if ($blog_query->have_posts()): ?>
                    ...
                    ?>
                        ...
                        <div class="relative overflow-hidden col-span-1 rounded-md" data-aos="fade-up" data-aos-delay="<?php echo esc_attr($animation_time); ?>">
