...
function Testimonials($bg_color = '#FFCB00', $quote_color = 'text-yellow-400', $testimonial_bg = '#FFF9E6', $title_class = "text-main")
{
    ...
    if ($testimonials): ?>
        <section class="w-full max-w-none mx-auto px-0 testimonial-slider py-10 relative">
            ...
            <!-- Slider -->
            <div class="splide z-[5]" aria-label="Testimonial Slider">
                <div class="splide__track">
                    <ul class="splide__list">
                        <?php foreach ($testimonials as $testimonial): ?>
                            <li class="splide__slide py-4 px-2 relative">
                                <div class="rounded-xl p-8  shadow-md flex flex-col justify-between "
                                    style="background-color: <?php echo esc_attr($testimonial_bg); ?>;">
