            ...
            ?>
                ...
                <div class="bg-white rounded-md w-full sm:w-[95%] mx-auto py-4 my-10 fade">
                    ...
                    <div class="flex flex-wrap justify-between items-center py-4 px-10">
                        <h3 class="font-bold font-main text-2xl md:text-3xl "><?= esc_html($main_title); ?></h3>
                    ...
                    <!-- content -->
                    <div class="p-4 rounded-lg border-transparent border-[2px] border-t-<?= esc_attr($category_slug); ?> grid grid-cols-1 md:grid-cols-5 gap-4 md:gap-8 px-10">
                        <!-- Image -->
                        <div class="lg:col-span-2 md:col-span-5 self-center">
                            ...
                            <!-- category button -->
                            <h4 class="bg-<?= esc_attr($category_slug); ?> text-white px-4 py-2 rounded-[50px] font-normal text-[12px] mt-4 md:mt-6 w-fit">
                                <?= esc_html($category); ?>
                            </h4>
                        </div>
                        ...
                        <div class="lg:col-span-3 md:col-span-5 py-4 flex flex-col gap-y-4">
                            <h5 class="font-normal font-main text-2xl md:text-4xl mb-4 md:mb-6"><?= esc_html($title); ?></h5>
