...
<header class="w-full h-screen bg-black relative overflow-hidden">
    <!-- Background Image -->
    <div class="absolute inset-0 h-full w-full overflow-hidden opacity-20 flex items-center justify-center" data-inview="background-fadeIn">
    ...
    <div class="container w-full h-full flex items-center justify-center flex-col p-5 relative z-10 mx-auto">
        <h3 class="capitalize text-white text-center text-[20px] leading-[1.6] md:text-5xl font-hanuman md:leading-[54px] mx-auto" data-inview="text-fadeInUp">
